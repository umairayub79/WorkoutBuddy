...
const Toast = ({ toast }) => {
    const classes = cx(
        'flex items-center py-2 px-3 shadow-md mb-2 z-[9999] rounded z',
        {
            'bg-red-600 border-s-4 border-red-800': toast.type === 'error',
            'bg-green-500 border-s-4 border-green-700': toast.type === 'success',
        }
    );
    ...
    return (
        <div className={classes}>
            <div className="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 ">
                {toast.type === 'success' ?
                    <div className="text-green-500 rounded-full bg-white me-3">
